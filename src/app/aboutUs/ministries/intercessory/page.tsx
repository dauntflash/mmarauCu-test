  ...
  const activities = [
    {
      ...
      description: "Regular prayer gatherings for interceding on behalf of the church and community.",
      icon: "🙏"
    },
    {
      title: "Prayer Chain",
      description: "A network of prayer warriors committed to lifting up prayer requests.",
      icon: "⛓️"
    },
    {
      title: "Spiritual Warfare",
      description: "Engaging in spiritual warfare through prayer and fasting.",
      icon: "⚔️"
    },
    {
      title: "Prayer Counseling",
      description: "Providing prayer support and spiritual guidance to those in need.",
      icon: "💝"
    }
  ];
  ...
  return (
    <div className="bg-gradient-to-b from-blue-50 to-white">
      ...
      <div className="relative w-full h-[70vh] overflow-hidden">
        <Image
          src="/bg/images/ministries/intercessory.jpg"
        ...
        >
          <h1 className="text-white text-4xl md:text-6xl font-bold">
            Intercessory <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-200 to-white">Ministry</span>
          </h1>
        ...
        >
          <motion.div variants={fadeInUp} className="text-center">
            <p className="text-gray-700 text-lg md:text-xl leading-relaxed">
              The Intercessory Ministry is dedicated to lifting up the church, its members, and the
              community in prayer. Through fervent prayer and spiritual warfare, we seek God's
              guidance, protection, and blessings for all.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-lg md:text-xl">
              To intercede on behalf of others and stand in the gap through prayer.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-lg md:text-xl">
              To build a strong foundation of prayer warriors who impact lives through intercession.
            </p>
          </motion.div>
