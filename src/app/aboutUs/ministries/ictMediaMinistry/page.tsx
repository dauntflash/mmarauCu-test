  ...
  const activities = [
    {
      ...
      description: "Providing technical assistance for church events and services.",
      icon: "🔧"
    },
    {
      title: "Media Production",
      description: "Creating and managing digital content for church communications.",
      icon: "🎥"
    },
    {
      title: "Live Streaming",
      description: "Managing live broadcasts of church services and events.",
      icon: "📡"
    },
    {
      title: "Digital Ministry",
      description: "Utilizing technology to enhance ministry outreach and engagement.",
      icon: "💻"
    }
  ];
      ...
      <div className="relative w-full h-[70vh] overflow-hidden">
        ...
        >
          <h1 className="text-white text-4xl md:text-6xl font-bold">
            ICT Media <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-200 to-white">Ministry</span>
          </h1>
        ...
        >
          <motion.div variants={fadeInUp} className="text-center">
            <p className="text-gray-700 text-lg md:text-xl leading-relaxed">
              The ICT Media Ministry combines technology and media to enhance the church's mission
              of spreading the gospel. We utilize modern tools and platforms to reach a wider audience
              and create engaging content that glorifies God.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-lg md:text-xl">
              To leverage technology and media for effective ministry and outreach.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-lg md:text-xl">
              To be at the forefront of digital ministry, reaching and engaging people through innovative technology.
            </p>
          </motion.div>
...
export default ICTMediaMinistry; 